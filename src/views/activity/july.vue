<template>
  <div class="activity-july-layer">
    <div class="banner">
      <img src="@/assets/active/july/banner.jpg"/>
      <p>活动时间：2019年7月1日-2019年7月31日</p>
    </div>
    <div class="bg-gradual">
      <div class="title"><span>奖励券天天领</span></div>
    ...
    <div class="title"><span>时来运转</span></div>
    ...
    <div class="luck-layer">
      ...
      <div class="rocker" :class="{active:this.step1.status}"></div>
    </div>
    ...
    <div class="copy-right">
      ...
      <p>深圳市亿钱贷电子商务有限公司</p>
      <p><a href="http://www.miit.gov.cn/" rel="noopener noreferrer" target="_blank">粤ICP备14041671号-1</a> | 市场有风险，出借需谨慎
      </p>
    </div>
    <am-modal class="activity-may-tips-modal activity-may-tips-modal2 am-text-center" @visible-change="onChangeModal2Visible"
              :isShow="isShowModal2" :closeBtn="false" :width="2.6" :height="3.7" cssUnit="rem">
      <am-modal-body>
        <p class="am-text-center title">
          <span>恭喜您领取成功</span>
        </p>
        <p class="am-text-center icon">
          <img src="@/assets/active/july/gift.png">
        </p>
    ...
    <am-modal class="activity-may-tips-modal am-text-center" @visible-change="onChangeModalVisible"
              :isShow="isShowModal" :closeBtn="false" :width="2.6" :height="3.1" cssUnit="rem">
      <am-modal-body>
        <p class="am-text-center title">
          <span>运气爆棚</span>
        </p>
    ...
    <am-modal class="activity-may-tips-modal4 am-text-center" @visible-change="onChangeModal4Visible"
              :isShow="isShowModal4" :closeBtn="false" :width="2.6" :height="3.1" cssUnit="rem">
      <am-modal-body>
        ...
        <div class="record-list">
          <table class="am-table am-table-bordered">
            ...
            <tr v-for="item in luckRecordList">
              ...
              <td>
                {{item.awardStatus=='1'&&item.awardType=='7'?'待确认':item.awardAmt}}{{item.awardStatus=='1'&&item.awardType=='7'?'':item.awardType=='3'?'%':'元'}}
              </td>
  ...
  export default {
    ...
    methods: {
      ...
      onProductListHandle() {
        ...
        //window.location.href = '/spa/product/auto'
      },
...
<style lang="less">
  @import "~@/style/less/views/activity/july";
</style>
