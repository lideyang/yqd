/**
 * Created by lidy on 2018/9/25.
 */
/* v1.2.25,1.2.26,1 2018-09-20 10:34:24 */
!function () {
    function cond() {
        return Math.random()
    }
    ...
    var GREY_RATIO = 1, QUERY_KEY = "aq-nc-grey-ratio", STABLE_ACTION = function () {
        ...
        !function (n) {
            ...
            function p(n, e) {
                if (!e) return !1;
                if (n.classList) {
                    for (var t = e.split(/\s+/), i = 0; i < t.length; i++) if (!n.classList.contains(t[i])) return !1;
                    return !0
                }
            ...
            var g = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (n) {
                ...
                }, h = window, v = document, m = "timeout", y = !!v.documentElement.classList,
                b = 1e10 * Math.random() >>> 0, k = function (n, e) {
            ...
            function i(n, e, t) {
                if (n) {
                    var i = 0, o = n.length;
                    if (o === +o) for (; o > i && e.call(t, n[i], i, n) !== !1; i++) ; else for (i in n) if (n.hasOwnProperty(i) && e.call(t, n[i], i, n) === !1) break
                }
            }
            ...
            var u = window, f = document, d = t(2), p = e.rndId = function (n) {
            ...
            e.each = i, e.hasClass = o, e.addClass = r, e.removeClass = a, e.toggleClass = function (n, e) {
                ...
                var e = p("_nc_r_"), t = u[e] = new Image;
                t.onload = t.onerror = function () {
                    u[e] = null
                }, t.src = n
            }, e.obj2param = c, e.addHourStamp = function (n, e) {
                var t = Math.floor((new Date).getTime() / (36e5 * (e || 2))), i = -1 === n.indexOf("?") ? "?" : "&";
                return n + i + "_t=" + t
            };
            var _ = {};
            e.isIEX = function (n) {
            ...
            e.getClientRect = function (n) {
                ...
                var t = g(e), i = {x: u.pageXOffset + n.clientX, y: u.pageYOffset + n.clientY};
                return {offsetX: i.x - t.x, offsetY: i.y - t.y}
            };
            var g = e.getPageCoord = function (n) {
                for (var e = {x: 0, y: 0}; n;) e.x += n.offsetLeft, e.y += n.offsetTop, n = n.offsetParent;
                return e
            }, h = {
                before: function (n, e) {
                    return function () {
            ...
            e.decorator = h, e.mix = function (n) {
                ...
                var t = [].slice, i = t.call(arguments, 2), o = function () {
                }, r = function () {
                ...
                var e = d.defer(), t = n.data || {}, i = ("jsonp_" + Math.random()).replace(".", "");
                u[i] = function (n) {
                    e.resolve(n)
            ...
            var l = 0, u = 1, f = 2;
            i.prototype = {
                constructor: i, then: function (n, e) {
                    var t = new i, r = o(t, n, "resolve"), a = o(t, e, "reject");
            ...
            function i(n) {
                var e = ("_nc_r_" + Math.random()).replace(/\./, ""), t = r[e] = new Image;
                t.onload = t.onerror = function () {
                    r[e] = null
                }, t.src = n
            }

            var o = (t(4).URL_MAP, "//cf.aliyun.com/scratchCardSlide/dataReport.jsonp"), r = window;
            e.log = function (n, e) {
                var t, r, a = e || o, c = ["a", "t", "scene", "ns", "jsv", "usa", "p", "jsType", "os", "em", "ec"],
                    s = [], l = c.length;
            ...
            "use strict";
            var i = t(1), o = {log: "//log.mmstat.com/", gm: "//gm.mmstat.com/", gj: "//gj.mmstat.com/"};
            e.mmstat_base = o;
            var r = i.isIEX(8), a = i.isIEX(7), c = i.isIEX(6), s = !!(c || a || r), l = {
                0: {
                    ...
                    umid_Url: "//g.alicdn.com/security/umscript/3.3.24/um.js",
                    uab_Url: "//aeu.alicdn.com/js/awsc.js",
            ...
            function i(n) {
                for (var e = [], t = {}, i = 0; i < n.length; i++) {
                    var o = n[i], r = o[0], a = o[1], c = o[2], s = o[3], l = {css: a, media: c, sourceMap: s};
            ...
            function o(n, e) {
                var t = g(), i = m[m.length - 1];
                if ("top" === n.insertAt) i ? i.nextSibling ? t.insertBefore(e, i.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild), m.push(e); else {
            ...
            function l(n, e, t, i) {
                ...
                if (n.styleSheet) n.styleSheet.cssText = y(e, o); else {
                    var r = document.createTextNode(o), a = n.childNodes;
                    a[e] && n.removeChild(a[e]), a.length ? n.insertBefore(r, a[e]) : n.appendChild(r)
                }
            }

            function u(n, e) {
                var t = e.css, i = e.media;
            ...
            function f(n, e) {
                var t = e.css, i = e.sourceMap;
                i && (t += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */");
                var o = new Blob([t], {type: "text/css"}), r = n.href;
            ...
            var r = {
                ...
                CHECK_Y: {cn: "\u9a8c\u8bc1\u901a\u8fc7", tw: "\u9a57\u8b49\u901a\u904e", en: "Verified"},
                CHECK_N: {
                    cn: "\u9a8c\u8bc1\u672a\u901a\u8fc7",
                    tw: "\u9a57\u8b49\u672a\u901a\u904e",
                    en: "Not Verified"
            ...
            if ("file:" === i.location.protocol) {
                ...
                for (r in o) if (o.hasOwnProperty(r)) {
                    a = o[r];
                    for (c in a) a.hasOwnProperty(c) && 0 === a[c].indexOf("//") && (a[c] = "http:" + a[c])
                }
            }
            e.URL_MAP = o
        }, function (n, e, t) {
                ...
                var t = {
                    ...
                    create: function (n, e) {
                        var i = "string" == typeof n.initial ? {state: n.initial} : n.initial,
                            o = n.terminal || n["final"], r = e || n.target || {}, a = n.events || [],
                            c = n.callbacks || {}, s = {}, l = {}, u = function (n) {
                    ...
                    leaveState: function (n, e, i, o, r) {
                        var a = t.leaveThisState(n, e, i, o, r), c = t.leaveAnyState(n, e, i, o, r);
                    ...
                    buildEvent: function (n, e) {
                        return function () {
                            var i = this.current, o = e[i] || (e[t.WILDCARD] != t.WILDCARD ? e[t.WILDCARD] : i) || i,
            ...
            var s, l = "javascript:NoCaptcha.reset()",
                u = "https://survey.taobao.com/survey/AMnMVgrS4?type=%TYPE&str=%STR", f = "{0}", d = {
                    _ggk_guide: "{0}",
                    _ggk_start: f,
                    _ggk_net_err: '{0}<a href="{1}">{2}</a>{3}<a rel="noopener noreferrer" target="_blank" href="{4}">{5}</a>',
                    _ggk_too_fast: '{0}<a href="{1}">{2}</a>{3}<a rel="noopener noreferrer" target="_blank" href="{4}">{5}</a>',
                    _ggk_action_timeout: '{0}<a href="{1}">{2}</a>{3}<a rel="noopener noreferrer" target="_blank" href="{4}">{5}</a>',
                    _ggk_fail: '{0}<a href="{1}">{2}</a>{3}<a rel="noopener noreferrer" target="_blank" href="{4}">{5}</a>',
                    _ggk_success: f,
                    _ggk_loading: "{0}"
                }, p = {
                    cn: {
            ...
            function r(n) {
                var e = l.querySelector("#" + n + "-stage-3"), t = l.querySelector("#" + n + "-stage-2");
                t && e && a && (e.parentNode.insertBefore(t, e), a.style.display = "none"), s = !1
            }

            var a, c, s, l = document;
            n.exports = {
                show: i, hide: r, setTEXT: function (n) {
                    c = n
                }
            }
        }, function (n, e, t) {
            ...
            function i(n, e) {
                if ("string" == typeof e && -1 !== e.indexOf(".")) {
                    var t = e.split("."), o = t[0], r = t.slice(1).join(".");
            ...
            function i(n) {
                var e, t = "", i = _.getElementById("umFlash");
                if (i && !t) try {
                    e = i.getCookie(n) || "", t = e
                } catch (o) {
                }
                ...
                if (p.navigator.cookieEnabled && !t) {
                    ...
                    if (-1 != r) {
                        ...
                        -1 == a && (a = _.cookie.length), e = decodeURIComponent(_.cookie.substring(r, a)) || "", t = e
                    }
                }
                return t
            }
            ...
            var u, f, d, p = window, _ = document, g = "_uab_collina",
            ...
            var i = t(25);
            "string" == typeof i && (i = [[n.i, i, ""]]), t(10)(i, {}), i.locals && (n.exports = i.locals)
        }, function (n, e, t) {
            "use strict";
            e.names = {
                init: "init",
            ...
            function r(n, e, t) {
                ...
                i = s.mix(i, n.apimap), function () {
                    ...
                    var d = encodeURIComponent(l.join("|")), p = i.umid_serUrl + "/dc.htm?token=" + n.token,
            ...
            var a = window, c = document, s = t(0), l = t(12).URL_MAP, u = t(48), f = (t(3), "timeout");
            e.load = function (n, e) {
                var t, o, a = !0, c = n.options, s = c.timeout || 1e4;
                i(c, function (i) {
                    t = 1;
                    var r = i == f;
            ...
            var i = t(0), o = t(14);
            e.init = function (n) {
                var e = n.fsm, t = i.mix({}, o.default_options, n.options || {});
                e.onenterfail = function () {
                    i.addClass(n.el, "nc-fail");
                    var e = n.scrape.prefix, o = document.getElementById(e + "container");
                    if (o && t.bg_back_fail) {
            ...
            e.init = function (n) {
                var e = n.fsm;
                e.onenterinitially = function () {
                }, e.onleaveinitially = function () {
                }
            }
        }, function (n, e, t) {
            "use strict";
            e.init = function (n) {
                var e = n.fsm;
                e.onenterload_error = function () {
                }, e.onleaveload_error = function () {
                }
            }
        }, function (n, e, t) {
            "use strict";
            var i = t(28), o = t(102), r = t(27), a = t(0), c = r.names, s = t(2);
            e.init = function (n) {
                var e = n.fsm;
            ...
            e.init = function (n) {
                ...
                e.onenterpass = function () {
                    ...
                    var e = (n.index > 0 ? n.index : 1, n.scrape.prefix), o = document.getElementById(e + "container");
                    if (o && t.bg_back_pass) {
                        var r = i.getElementsByClassName("nc-bg", o)[0];
            ...
            e.init = function (n) {
                var e = n.fsm;
                e.onenterts_loading = function () {
                }, e.onleavets_loading = function () {
                }
            }
        }, function (n, e, t) {
            "use strict";
            ...
            !function (n, e) {
                ...
                if (n.getElementsByTagName("head")[0].appendChild(t), t.styleSheet) t.styleSheet.disabled || (t.styleSheet.cssText = e); else try {
                    t.innerHTML = e
                } catch (i) {
                    t.innerText = e
                }
            ...
            var o = window, r = document, a = t(48), c = t(11), s = 0, l = t(27), u = t(20);
            i.prototype = {
                init: function (n) {
            ...
            var o = function () {
                ...
                }(), r = t(13), a = t(17), c = t(0), s = t(3), l = t(2),
                u = [{name: "init", from: "initially", to: "loading"}, {
                    ...
                    from: "ts_verifying",
                    to: "ts_pass"
                }, {name: "ts_passed", from: "ts_pass", to: "pass"}], f = function () {
                    function n(e, t) {
                        i(this, n);
                        var o = "cn";
            ...
            e.makeClickSlider = function (n) {
                ...
                function l() {
                    var e = _.getBoundingClientRect(), t = _.clientWidth - v.clientWidth;
            ...
            var _slicedToArray = function () {
                ...
                }(), html = __webpack_require__(81).html, kvTpl = __webpack_require__(19), util = __webpack_require__(0),
                cfg = __webpack_require__(14), URL_MAP = __webpack_require__(12).URL_MAP,
                language = __webpack_require__(15).language, replaceLang = __webpack_require__(15).replaceLang,
                upResetIndex = __webpack_require__(15).upResetIndex, Promise = __webpack_require__(2),
                Report = __webpack_require__(3), doc = document, getElementById = function (n) {
            ...
            var obj_w = -1, obj_h = -1, Scrape = function () {
                function Scrape(n) {
                    ...
                    var t = {};
                    if (e.foreign && (t.language = t.language || "en"), this.options = util.mix({}, cfg.default_options, t, n.options || {}, e), this._last_x = -1, this._last_y = -1, this.stroke_size = e.stroke_size || cfg.default_stroke_width, this.svr_data = {}, this._t_action = null, this.is_downgraded = !1, this._lang = language[this.options.language] || language.cn, this.options.upLang) for (var i in this.options.upLang) this._lang = replaceLang(i, this.options.upLang[i]);
                ...
                return _createClass(Scrape, [{
                    ...
                    key: "loading_initGetSize", value: function () {
                        var n = this, e = this.options.objects;
                    ...
                    key: "getParamOl", value: function () {
                        var n = this.el_nc_canvas, e = util.getElementLeft(n), t = util.getElementTop(n);
                        return {x: e, y: t}
                    }
                }, {
                    key: "loading_sendInitReq", value: function () {
                        var n = this;
                        return new Promise(function (e, t) {
                            var i = n.options, o = n.getParamOl(),
                    ...
                    key: "getEl", value: function (n) {
                        return getElementById(this.prefix + n)
                    }
                }, {
                    key: "putObjects", value: function () {
                        var n = this, e = this.svr_data, t = e.objectPoints, i = t.points;
                        ...
                        o.innerHTML = util.map(i, function (e, t) {
                            var i = e.x, o = e.y, r = i - n.obj_w / 2, a = o - n.obj_h / 2, c = n.options.elements,
                                s = c[t % c.length];
                    ...
                    key: "getSize", value: function () {
                        var n = {width: this.options.width, height: this.options.height},
                            e = this.options.hasOwnProperty("width"), t = this.options.hasOwnProperty("height"),
                    ...
                    key: "mkGridId", value: function (n, e) {
                        return [this.prefix, "grid", n, e].join("-")
                    }
                }, {
                    key: "render_surface_dg", value: function () {
                        var n = this, e = this.getEl("canvas-dg"), t = this.size.width, i = this.size.height;
                        e.style.width = t + "px", e.style.height = i + "px", e.style.display = "block";
                        for (var o = cfg.grid_size, r = Math.ceil(t / o), a = Math.ceil(i / o), c = [], s = this.options.bg_back, l = 0; a > l; l++) for (var u = 0; r > u; u++) {
                            var f = o * l, d = o * u, p = {
                                    width: o + "px",
                                    height: o + "px",
                                    top: f + "px",
                    ...
                    key: "render_surface", value: function () {
                        ...
                        var e = this.el_canvas, t = this.ctx, i = this.size;
                        ...
                        l.src = this.options.bg_front, l.onload = function () {
                            ...
                            for (var n = l.naturalWidth ? [l.naturalWidth, l.naturalHeight] : [l.width, l.height], e = _slicedToArray(n, 2), o = e[0], r = e[1], a = Math.ceil(i.width / o), c = Math.ceil(i.height / r), s = 0; c > s; s++) for (var u = 0; a > u; u++) t.drawImage(l, u * o, s * r);
                    ...
                    key: "getPos", value: function (n) {
                        var e = doc.documentElement.scrollLeft || doc.body.scrollLeft,
                            t = doc.documentElement.scrollTop || doc.body.scrollTop, i = this.options.renderTo,
                            o = getElementById(0 === i.indexOf("#") ? i.slice(1) : i), r = 0, a = 0;
                    ...
                    key: "_clearTo_dg", value: function (n, e) {
                        var t = Math.floor(n / cfg.grid_size), i = Math.floor(e / cfg.grid_size),
                            o = this.mkGridId(t, i), r = document.getElementById(o);
                        util.addClass(r, "nc-clean");
                        var a = this._grid_x_count * i + t;
                        this.matrix[a] = 0
                    }
                }, {
                    key: "_clearTo", value: function (n, e) {
                    ...
                    key: "_calcRegion", value: function (n, e, t, i) {
                        for (var o = this.ctx.getImageData(n, e, t, i).data, r = 0, a = 0; a < o.length; a += 4) o[a] && o[a + 1] && o[a + 2] && o[a + 3] && r++;
                        return 1 - r / t / i
                    }
                }, {
                    key: "_calcRegion_dg", value: function (n, e, t, i) {
                        for (var o = cfg.grid_size, r = Math.floor(n / o), a = Math.floor(e / o), c = Math.floor(t / o), s = Math.floor(i / o), l = 0, u = a; a + s > u; u++) for (var f = r; r + c > f; f++) {
                    ...
                    key: "calc_dg", value: function () {
                        var n = this, e = void 0, t = void 0, i = this.matrix.reduce(function (n, e) {
                            return n + e
                        }, 0);
                        e = 1 - i / this._grid_sum;
                        var o = this.is_downgraded ? .7 : .9, r = this.obj_w / 2 * o, a = this.obj_h / 2 * o;
                    ...
                    key: "calc", value: function () {
                        ...
                        var e = this.size, t = e.width, i = e.height, o = this._calcRegion(0, 0, t, i),
                            r = this.obj_w / 2, a = this.obj_h / 2, c = util.map(this._points, function (e) {
                                var t = e.x, i = e.y;
                    ...
                    key: "checkEnd", value: function (n, e) {
                        var t = 0 === e.filter(function (n) {
                            return .5 > n
                        }).length;
                        if ((n > .9 || t) && window.__captchah5__uab.isReadyForSC(window.__captchah5_uaboption.mIDs) && "ready" === this.nc.fsm.current) this.verify(); else if (n > .9 && t) {
                            try {
                                UA_Opt.sendSA()
                            } catch (i) {
                            }
                    ...
                    key: "verify_ok", value: function (n) {
                        this.verify_result = n, this.nc.fsm.verifypass()
                    }
                }, {
                    key: "verify_fail", value: function (n) {
                        this.nc.fsm.verifyfail()
                    }
                }, {
                    key: "_upResetIndex", value: function (n) {
                        return upResetIndex(n, this.nc.index)
                    }
                }, {
                    key: "_mkErrInfo", value: function (n) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                            t = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = this.options,
                            o = n, r = [i.appkey, i.token, i.scene], a = "";
                        switch (n) {
                            case FAIL_PREPARE:
                    ...
                    key: "_updateSurveyUrl", value: function (n, e, t) {
                    ...
                    key: "on_load_error", value: function (n) {
                        var e = this;
                        return new Promise(function (n, t) {
                            util.addClass(e.root, "nc-state-load-error"), util.removeClass(e.root, "nc-prepared");
                            var i = function o() {
                                var t = e.getEl("load-error"), i = void 0, r = e.getEl("cover");
                    ...
                    key: "getErrIcon", value: function (n) {
                        return this.options.obj_error
                    }
                }, {
                    key: "tryToUpdateErrIcon", value: function () {
                        var n = this.getEl("fail-icon"), e = this.getEl("load-error-icon");
                    ...
                    key: "eventDown", value: function (n) {
                        try {
                            n.preventDefault()
                        } catch (e) {
                        }
                        if ("ready" == this.nc.fsm.current) {
                            ...
                            var t = this.getPos(n), i = _slicedToArray(t, 2), o = i[0], r = i[1];
                    ...
                    key: "eventMove", value: function (n) {
                        var e = this;
                        try {
                            n.preventDefault()
                        } catch (t) {
                        ...
                        if (this.mousedown) {
                            ...
                            var i = this.getPos(n), o = _slicedToArray(i, 2), r = o[0], a = o[1];
                            this._clearTo(r, a);
                    ...
                    key: "mkMatrix", value: function () {
                        var n = this.size, e = n.width, t = n.height, i = cfg.grid_size, o = Math.ceil(e / i),
                            r = Math.ceil(t / i), a = o * r;
                    ...
                    key: "bindEvents", value: function () {
                        var n = this, e = this.getEl("btn-refresh"), t = this.getEl("btn-info");
                    ...
                    key: "showEl", value: function (n) {
                        var e = this.getEl(n);
                        e && (e.style.display = "block")
                    }
                }, {
                    key: "hideEl", value: function (n) {
                        var e = this.getEl(n);
            ...
            e.makeFSM = function (n) {
                var e = i.create({
                    initial: "initially",
                    events: [{name: "init", from: "initially", to: "loading"}, {
                        name: "load",
                        from: "loading",
                        to: "ready"
                ...
                return e.onleavestate = function (n, e, t) {
                }, e.onenterstate = function (n, e, t) {
                }, t(89).init(e, n), t(88).init(e, n), t(92).init(e, n), t(99).init(e, n), t(87).init(e, n), t(86).init(e, n), t(91).init(e, n), t(90).init(e, n), t(96).init(e, n), t(98).init(e, n), t(29).init(e, n), t(95).init(e, n), t(94).init(e, n), t(97).init(e, n), t(93).init(e, n), t(85).init(e, n), e
            }
        }, function (n, e, t) {
            "use strict";
            var i = window, o = document, r = t(0), a = t(6).v, c = t(12).URL_MAP;
            e.makeNet = function (n, e) {
                ...
                function d(n) {
                    ...
                    t(h.analyze, u, function (t, i) {
                        var o = "ok" === t && i && i.success && 0 === i.result.code, r = i && i.result ? i.result : {};
                        e.sid = g = r.csessionid, e.captcha_type = r.value, n({pass: o, state: t}, r)
                    }, _.timeout || 1e4)
                }
                ...
                var _ = e.options, g = "", h = c[_.foreign] || c[0];
                return h = r.mix(h, _.apimap), {initialize: s, postSlide: d, postCaptcha: p, send: t}
            }
        }, function (n, e, t) {
            "use strict";
            var i = document, o = t(0), r = t(11);
            ...
            "use strict";
            var i = window, o = t(28), r = t(0), a = t(101).makeUI;
            e.init = function (n, e) {
                function t(n) {
                    return e._TEXT(n)
                }
            ...
            e.init = function (n, e) {
                ...
                n.onenterready = function () {
                    var n = i(".label"), o = "//img.alicdn.com/tfs/TB1GhJXQXXXXXa.XFXXXXXXXXXX-75-52.png";
                    e.options.isClick ? n.innerHTML = "" : n.innerHTML = t("SLIDER_LABEL");
                    var r = e.container.querySelector(".stage2 .textbox"), a = r && r.querySelector("input");
            ...
            "use strict";
            var i = t(12).URL_MAP, o = t(0), r = t(29);
            e.init = function (n, e) {
                function t(n) {
                    return e._TEXT(n)
                }
                ...
                function c() {
                    ...
                    var _, g = a("img.code"), h = a(".input"), v = a(".icon.clear"), m = a(".icon.refresh"),
                        y = a(".btn-ok"), b = a(".tips"), k = a(".placeholder");
                ...
                var s, l = e.options, u = i[l.foreign] || i[0];
            ...
            e.init = function (n, e) {
                n.onenterts_ready = function () {
                    e.fire("afterverify");
                    var n = e.container.querySelector(".stage2 .textbox"), t = n && n.querySelector("input");
                    t && t.focus()
                }
            }
        }, function (n, e, t) {
            ...
            "use strict";
            var i = window, o = t(16), r = t(100), a = t(84), c = t(78), s = t(0);
            e.makeUI = function (n) {
                function e(e) {
                    return n._TEXT(e)
                }
                ...
                function u(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, i = g[h];
                ...
                function d() {
                    ...
                    var a = t(".input"), c = t(".icon.clear"), s = t(".btn-ok"), l = t(".tips"), u = t(".placeholder");
                ...
                function p() {
                    var o = t(".menu.refresh"), r = t(".menu.feedback");
                    o.onclick = function () {
