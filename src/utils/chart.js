...
export const setArea = (element, w, h) => {
  ...
  element.style.cssText = `width: ${w + 220}px;height: ${h + 120}px`
  console.log(`width: ${w + 220};height: ${h + 120}`)
  element.setAttribute('width', (w + 220) * ratio);
  element.setAttribute('height', (h + 120) * ratio);
  console.log(ratio);
