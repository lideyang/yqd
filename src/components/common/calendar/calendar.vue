...
.wh_content_all {
  ...
  background: linear-gradient(120deg,#312488,#295ecc);
  width: 100%;
  overflow: hidden;
  padding-bottom: 8px;
}
...
export default {
  ...
  methods: {
    ...
    ChoseDay: function(date) {
      date = timeUtil.dateFormat(date);
      this.myDate = new Date(date);
      this.getList(this.myDate, date, true);
    },
